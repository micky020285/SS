...
public class UserContactsCreationFromSFUsingRecordTypePartner extends BaseClass
{
	...
	public void test(String...testData) throws Exception
	{
		...
		if (contactName!=null) {
			extentTest.log(LogStatus.PASS, "Partner contact Created succesfully :" + contactName);
		}
