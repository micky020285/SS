...
public class UserAccountsCreationFromSFUsingRecordTypeEndCustomer extends BaseClass
{
	...
	public void test(String...testData) throws Exception
	{
		...
		if (accountName!=null) {
			extentTest.log(LogStatus.PASS, "End Customer Account Created succesfully :" + accountName);
		}
