...
public class UserAccountsCreationFromSFUsingRecordTypePartnerAccountCountry extends BaseClass
{
	...
	public void test(String...testData) throws Exception
	{
		...
		*/
		...
		if (accountName!=null) {
			extentTest.log(LogStatus.PASS, "Partner Account(Country) Created succesfully :" + accountName);
		}
