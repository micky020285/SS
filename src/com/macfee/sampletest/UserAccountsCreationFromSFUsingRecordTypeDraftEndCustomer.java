...
public class UserAccountsCreationFromSFUsingRecordTypeDraftEndCustomer extends BaseClass
{
	...
	public void setup()
	{
		...
		//sfTestUserProfile=Custom: CRM Analyst/Territory Admin
		salesHomePage.onClickLoginBtn();
		
		/*
		salesHomePage.ClickOnLoggedUser();
		setupUser = salesHomePage.ClickOnSetUp();
	...
	public void test(String...testData) throws Exception
	{
		...
		if (accountName!=null) {
			extentTest.log(LogStatus.PASS, "Draft End Customer Account Created succesfully :" + accountName);
		}
