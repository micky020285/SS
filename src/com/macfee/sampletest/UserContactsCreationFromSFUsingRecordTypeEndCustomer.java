...
public class UserContactsCreationFromSFUsingRecordTypeEndCustomer extends BaseClass
{
	...
	public void test(String...testData) throws Exception
	{
		...
		*/
		...
		if (contactName!=null) {
			extentTest.log(LogStatus.PASS, "End Customer Contacts Created succesfully :" + contactName);
		}
